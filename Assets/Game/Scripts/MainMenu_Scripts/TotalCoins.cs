...
public class TotalCoins : MonoBehaviour
{
	...
	ByPopupMenuParent, UnSufficentCoinsMenuParent, LevelSelectionMenuParent, StoreMenuParent,UnsufficentCoinsForPlayerselectionMenu;
...
//		//Fahad
//		PlayerPrefs.SetInt ("TotalCoins", 100000);
//		//End
				UpdateCoins ();
				Static = this;
		}
